...
interface TableProps {
    ...
    expertTypeDelete: (id: number) => void
}
export const ExpertTypeTable : React.FC<TableProps> = ({
    expertTypeData,
    statusChange,
    expertTypeDelete
}) => {
  ...
  const columns = React.useMemo(
                ...
                {values.row.original.status !== 0 && (
                  ...
                  <>
                    ...
                    <button
                        ...
                        expertTypeDelete(values.row.original.id)
                      }}
    ...
    [statusChange, expertTypeDelete , expertTypeData]
  )

  return <DataTable columns={columns} data={expertTypeData} />
}