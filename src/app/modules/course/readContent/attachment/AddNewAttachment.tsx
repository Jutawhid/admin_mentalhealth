...
export const AddNewAttachment: React.FC = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values, { setStatus, setSubmitting }) => {
      ...
      const data:any = {
       ...
       formData.append('course_read_content_id', courseAttachmentId.toString());
       formData.append('content_type', values.content_type);
       formData.append('file_name', values.file_name);
       formData.append('url', values.url );

      courseAttachmentAPI.addNewAttachment(formData).then(
        (res: any) => {
