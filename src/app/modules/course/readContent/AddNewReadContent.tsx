...
const validationSchema = Yup.object().shape({
    title: Yup.string().matches(/^[a-zA-Z]/,"Title must be start with alphabet character ! No special character and alphabet character allowed").required('Title is required').min(2,'Title must be greater than 2 character').max(50,'Title must be less than 50 character'),
...
export const AddNewReadContent: React.FC = () => {
    ...
    const formik = useFormik({
        ...
        onSubmit: (values, { setStatus, setSubmitting } ) => {
            ...
            readContentAPI.addNewReadContent(courseId,values).then(
                (res: any) => {
    ...
    return (
        <>
            ...
            <PageTitle>Add Read Content</PageTitle>
            {/* card start */}
                ...
                <div className="card-body">
                    <form onSubmit={formik.handleSubmit}>
                      ...
                      <div className='row'>
                        ...
                        <div className="form-group mt-5 form-m-top_upto_md">
                                <label htmlFor="readTime" className='required'>Details</label>
                                {/* <textarea
                                    rows={4}
                                    placeholder="Enter Read Content Details"
