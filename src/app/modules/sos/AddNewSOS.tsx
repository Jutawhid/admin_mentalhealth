...
const validationSchema = Yup.object().shape({
  ...
  number: Yup.string()
    // .matches(
    //   /^[0-9]+$/,
    //   "Number must be numeric value ! No alphabet character and special character are allowed "
    // )
    .required("Number is required"),
});

export const AddNewSOS: React.FC = () => {
