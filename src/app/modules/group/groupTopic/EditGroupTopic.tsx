...
export const EditGroupTopic: React.FC = () => {
    ...
    const formik = useFormik({
        ...
        onSubmit: (values, { setStatus, setSubmitting }) => {
            ...
            groupTopicAPI.updateGroupTopic(details.id,values).then(
                (res: any) => {
    ...
    const getDetails = (id: number) => {
        ...
        groupTopicAPI.getDetails(id).then(
          (res: any) => {
    ...
    return (
        <>
            ...
            <PageTitle>Update Group Topic</PageTitle>
            {/* card start */}
            { loading ? <Loading/> :(
